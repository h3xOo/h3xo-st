...
static char *font2[] = { "Hack Nerd Font Mono:pixelsize=10:antialias=true:autohint=true",
...
static float const cwscale = 1.0;
static float const chscale = 1.0;
...
static unsigned int const doubleclicktimeout = 300;
static unsigned int const tripleclicktimeout = 600;
 ...
 * attribute.
 */
static unsigned int const blinktimeout = 800;

/*
 * thickness of underline and bar cursors
 */
static unsigned int const cursorthickness = 2;
 ...
 *	stty tabs
 */
unsigned int const tabspaces = 8;
 ...
 */
unsigned int const defaultfg = 259;
unsigned int defaultbg = 258;
unsigned int const defaultcs = 256;
static unsigned int const defaultrcs = 257;
static unsigned int const background = 258;
 ...
 * 7: Snowman ("☃")
 */
static unsigned int const cursorshape = 2;
 ...
 */
static unsigned int const mouseshape = XC_xterm;
static unsigned int const mousefg = 7;
 ...
 */
static unsigned int const defaultattr = 11;
 ...
 */
static uint const forcemousemod = ShiftMask;

/*
 * Xresources preferences to load at startup
 */
static ResourcePref const resources[] = {
        { "font", STRING, &font },
...
static MouseShortcut const mshortcuts[] = {
  /* mask                 button   function        argument       release */
        { XK_NO_MOD, Button4, kscrollup, { .i = 1 } },     { XK_NO_MOD, Button5, kscrolldown, { .i = 1 } },
 ...
 */
static uint const ignoremod = Mod2Mask | XK_SWITCH_MOD;

/*
 * This is the huge key array which defines all compatibility to the Linux
 * world. Please decide about changes wisely.
 */
static Key const key[] = {
 ...
 */
static char const ascii_printable[] = " !\"#$%&'()*+,-./0123456789:;<=>?"
