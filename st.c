...
static void execsh(const char*, char**);
...
static char base64dec_getc(const char** src)
{
...
void execsh(const char* cmd, char** args)
{
    const char *sh;
    char *prog, *arg;
...
int ttynew(const char* line, const char* cmd, const char* out, char** args)
{
    int m, s;
