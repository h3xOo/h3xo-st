...
// FEATURE('s','s','0','2'), FEATURE('s','s','0','3'),
// FEATURE('s','s','0','5'), FEATURE('s','s','0','6'),
// FEATURE('s','s','0','7'), FEATURE('s','s','0','8'), FEATURE('z','e','r','o')
// };
...
hbfindfont (XftFont *match)
{
    ...
    hbfontcache
        = realloc (hbfontcache, sizeof (HbFontMatch) * (hbfontslen + 1));
    ...
    for (int idx = 1, specidx = 1; idx < len; idx++)
        {
            ...
            if (specs[specidx].font != specs[start].font
                ...
                {
                    hbtransformsegment (specs[start].font, glyphs, codepoints,
                                        gstart, length);
...
void
hbtransformsegment (XftFont *xfont, const Glyph *string,
                    hb_codepoint_t *codepoints, int start, int length)
{
